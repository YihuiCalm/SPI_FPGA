...
HD_PWD='D:/Github/SPI_FPGA/SPI_FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_Read_Flash.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_Read_Flash.tcl
