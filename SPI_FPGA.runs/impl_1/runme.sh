...
HD_PWD='D:/Github/SPI_FPGA/SPI_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_Read_Flash.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_Read_Flash.tcl -notrace
