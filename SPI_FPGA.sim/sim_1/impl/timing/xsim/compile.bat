...
REM
REM Generated by Vivado on Sun Apr 30 07:31:52 -0400 2023
...
echo "xvlog --incr --relax -prj SPI_Flash_read_tb_vlog.prj"
call xvlog  --incr --relax -prj SPI_Flash_read_tb_vlog.prj -log xvlog.log
